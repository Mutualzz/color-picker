# Contributing to @mutualzz/color-picker

Thanks for wanting to help with **@mutualzz/color-picker**.

Contributions are welcome. Redistributing unofficial builds or hosting a
competing Mutualzz service is still not allowed — see [`LICENSE`](https://github.com/Mutualzz/color-picker/blob/master/LICENSE).
